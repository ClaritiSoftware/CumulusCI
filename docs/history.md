...
-   DEVOPS-928 fix: hardcoded upstream SFDO-Tooling references in CI workflows and cci version output by [@dipakparmar](https://github.com/dipakparmar) in [#27](https://github.com/ClaritiSoftware/CumulusCI/pull/27)
